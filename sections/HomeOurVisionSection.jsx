...
const HomeOurVisionSection = () => {
  return (
    <div id="vision" data-aos="fade-up" className="w-full max-w-[1160px] h-[400px] md:h-[350px] mx-auto mt-8 group relative overflow-hidden bg-vision-section  p-10 text-white font-semibold rounded-xl">
      <div className="relative z-[9] flex flex-col gap-y-3 md:flex-row items-center h-full">
        <h2 className="text-4xl md:text-6xl font-bold">Our Vision</h2>
        <p className="md:absolute text-center md:text-left md:w-[600px] transition-all ease-in-out duration-300 -right-full top-20 group-hover:right-20">
      ...
      <div className="absolute flex items-center h-full top-0 right-4 md:right-10 z-[9]">
